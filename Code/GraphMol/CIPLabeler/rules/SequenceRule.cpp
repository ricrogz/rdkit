...
std::uint8_t getOutgoingMask(const Node *node, const EdgeVector &edges) {
...
int8_t SequenceRule::recursiveCompareEqual(const Edge *a, const Edge *b) const {
